...
public:
	...
	static void Init();
	//		キー入力情報更新
	//	@note		:	ここでキー情報を更新していますので、毎回呼んでください
	static void	UpdateKey();

	//		キー入力情報取得
	//	key		:	チェックするキー
	//	@return		:	キーを入力したか?
	static bool	IsPushKeyLaw(int key);
	//		キートリガー入力情報取得
	//	key		:	チェックするキー
	//	@return		:	キーを1度だけ入力したか?
	static bool	IsPushKeyTrg(int key);
	//		キーを離したかの情報取得
	//	key		:	チェックするキー
	//	@return		:	キーを離したか?
	static bool	IsPushKeyRel(int key);
	//		キー入力情報取得
	//	key		:	チェックするキーのポインタ
	//	checkNum	:	チェックする数
	//	@return		:	キーを入力したか?
	static bool	IsPushKeyLaw(int* key, int checkNum);
	//		キートリガー入力情報取得
	//	key		:	チェックするキーのポインタ
	//	checkNum	:	チェックする数
	//	@return		:	キーを1度だけ入力したか?
	static bool	IsPushKeyTrg(int* key, int checkNum);
	//		キーを離したかの情報取得
	//	key		:	チェックするキーのポインタ
	//	checkNum	:	チェックする数
	//	@return		:	キーを離したか?
	static bool	IsPushKeyRel(int* key, int checkNum);
};
