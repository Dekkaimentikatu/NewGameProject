...
//		初期化
//-------------------------------
void DebugCamera::Init(VECTOR pos, VECTOR focus, VECTOR up)
{
	m_pos = pos;
	m_focus = focus;
	m_up = up;
...
//		注視点の前後移動
//-------------------------------
void DebugCamera::MoveFrontBack()
{
	VECTOR dir;
	// 前進
...
//		注視点の左右移動
//-------------------------------
void DebugCamera::MoveLeftRight()
{
...
//		注視点の左右移動
//-------------------------------
void DebugCamera::RotateLeftRight()
{
	float fDir = 0.0f;
	// 入力したキーに応じて回転方向を変える
