...
//		アニメリクエスト
//---------------------------------
void	Model::Request(int animID, float animSpd, int animSrcHndl, bool isNameCheck)
{
	DetachAnim();

	m_animData.m_hndl = MV1AttachAnim(m_hndl, animID, animSrcHndl, isNameCheck);
...
//		ループアニメリクエスト
//---------------------------------
void	Model::RequestLoop(int animID, float animSpd, int animSrcHndl, bool isNameCheck)
{
	DetachAnim();
...
//		エンドループアニメリクエスト
//---------------------------------
void	Model::RequestEndLoop(int animID, float animSpd, int animSrcHndl, bool isNameCheck)
{
	DetachAnim();
