...
void C_PLAYER::Init()
{
	...
	m_objectData.modelScale = VGet(0.5f, 0.5f, 0.5f);	//スケール
...
void C_PLAYER::Load()
{
	...
	m_objectData.modelScale = VGet(0.05f, 0.05f, 0.05f);
	...
	DuplicateModel(incetans->Get3DModelHndl(PLAYER_MODELE_PATH));
